...
export default function GraphStats({ nodes, relationships, clusters }: GraphStatsProps) {
  return (
    <motion.div
      ...
      className="pointer-events-none absolute bottom-5 right-5 z-10 rounded-2xl border border-border/40 bg-card/60 px-5 py-4 backdrop-blur-md dark:bg-card/40"
    >
